...
class SchemeTest extends TestCase
{
    ...
    public function testRenderPropertiesInTheOrderTheyArePassed(): void
    {
        ...
        $this->assertEquals(
            '<span itemscope itemprop="fake-scheme" itemtype="http://schema.org/FakeScheme"><span itemprop="addressRegion">OR</span><span class="spc">&#8203;</span><a itemprop="url" href="https://www.alwaysblank.org">Visit Me!</a><span class="spc">&#8203;</span></span><span class="spc">&#8203;</span>',
            $forward->render()
        );
        $this->assertEquals(
            '<span itemscope itemprop="fake-scheme" itemtype="http://schema.org/FakeScheme"><a itemprop="url" href="https://www.alwaysblank.org">Visit Me!</a><span class="spc">&#8203;</span><span itemprop="addressRegion">OR</span><span class="spc">&#8203;</span></span><span class="spc">&#8203;</span>',
            $backward->render()
        );
    }
    ...
    public function testRenderMultiplePropertiesOfIdenticalType(): void
    {
        ...
        $this->assertEquals(
            '<span itemscope itemprop="fake-scheme" itemtype="http://schema.org/FakeScheme"><span itemprop="addressRegion">OR</span><span class="spc">&#8203;</span><a itemprop="url" href="https://www.alwaysblank.org">Visit Me!</a><span class="spc">&#8203;</span><span itemprop="addressRegion">CA</span><span class="spc">&#8203;</span><span itemprop="addressRegion">MA</span><span class="spc">&#8203;</span></span><span class="spc">&#8203;</span>',
            $scheme->render()
        );
    }
}
